...
class CarState(CarStateBase):
  ...
  def update(self, can_parsers) -> structs.CarState:
    ...
    if self.CP.enableGasInterceptorDEPRECATED:
      ...
      # Panda 595 threshold = 12.57. Set lower to avoid panda blocking messages and GasInterceptor faulting.
      threshold = 12 if self.CP.carFingerprint in CAMERA_ACC_CAR else 4
